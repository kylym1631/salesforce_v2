...
<section id="team" class="team_area bg-gray pt-120 pb-120">
    <div class="container">
        <div class="justify-center row">
            <div class="w-full lg:w-2/3 wow fadeIn"   data-wow-duration="1s" data-wow-delay="0.2s">
                <div class="pb-8 text-center section-title">
                    <div class="m-auto line"></div>
                    <h3 class="title"><span>Meet Our</span> Beloved Mentors</h3>
                </div> <!-- section title -->
            </div>
        </div><!-- row -->
        <div class="team-wrapper relative wow fadeIn"   data-wow-duration="1s" data-wow-delay="0.2s">
                    ...
                    <div class="single_team_item mx-auto">
                        <div class="single_team mx-3">
                            ...
                            <div class="team_content py-5 px-8 relative">
                                <h4 class="team_name text-xl md:text-2xl"><a href="#" class="text-black group-hover:text-white">Aalambek Ulukbek</a></h4>
                                <p class="mt-2 transition-all duration-300 group-hover:text-white">Salesforce Consultant</p>
                            </div>
                        </div> <!-- single team -->
                    </div>
                </div>
                ...
                <div class="w-full lg:w-4/12">
                    <div class="single_team_item mx-auto">
                        <div class="single_team mx-3">
                            ...
                            <div class="team_content py-5 px-8 relative">
                                <h4 class="team_name text-xl md:text-2xl"><a href="#" class="text-black group-hover:text-white">Islambek Baizhigitov</a></h4>
                                <p class="mt-2 transition-all duration-300 group-hover:text-white">Developer</p>
                            </div>
                        </div> <!-- single team -->
                    </div>
