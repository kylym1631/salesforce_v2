                ...
                <div class="pl-0 mt-12 counter-wrapper lg:pl-16 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                    <div class="counter-content">
                        <div class="mb-8 section-title">
                            <div class="line"></div>
                            <h3 class="title">Why<span class="hover-blue"> Salesforce?</span></h3>
                        </div> <!-- section title -->
                        <p class="text">Salesforce is one of the world’s largest technology companies. Behind the scenes of your favorite companies such as <span class="hover-blue">Apple, Facebook & Uber, Salesforce</span> is powering all of them.</p>
                        <ul class="about_list pt-3">
                            <li class="flex mt-5">
                                ...
                                <div class="about_list_content pl-5 pr-2">
                                    <p>No need IT background & easy to learn</p>
                            ...
                            <li class="flex mt-5">
                                ...
                                <div class="about_list_content pl-5 pr-2">
                                    <p><a href="https://qubit-labs.com/salesforce-developer-salary-in-the-world-guide-2021/">2000 - 9000 EUR</a>  monthly salary in europe</p>
                                </div>
                            </li>
                            <li class="flex mt-5">
                                <div class="about_check">
                                ...
                                <div class="about_list_content pl-5 pr-2">
                                    <p>Offers  high-quality product and  powerful ecosystem</p>
                                </div>
                            </li>
                        </ul>
                    </div> <!-- counter content -->
                    <div class="row no-gutters">
                        <div class="flex items-center justify-center single-counter counter-color-1">
                            <div class="text-center counter-items">
                                <span class="text-2xl font-bold text-white"><span class="counter">#1</span></span>
                                <p class="text-white">CRM</p>
                            </div>
                        </div> <!-- single counter -->
                        <div class="flex items-center justify-center single-counter counter-color-2">
                            <div class="text-center counter-items">
                                <span class="text-2xl font-bold text-white"><span class="counter">150</span>K+</span>
                                <p class="text-white">Active Users</p>
                            </div>
                        </div> <!-- single counter -->
                        <div class="flex items-center justify-center single-counter counter-color-3">
                            <div class="text-center counter-items">
                                <span class="text-2xl font-bold text-white"><span class="counter">4.5</span></span>
